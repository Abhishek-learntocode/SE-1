...
public class PlanetManagerLocalTest  {
    ...
    public void setUp() throws Exception {
        ...
        try {
            ...
            testEntry1.setCategory(WebloggerFactory.getWeblogger().getWeblogEntryManager().getWeblogCategoryByName(testWeblog, "General"));
            ...
            testEntry2.setCategory(WebloggerFactory.getWeblogger().getWeblogEntryManager().getWeblogCategoryByName(testWeblog, "General"));
            ...
            testEntry3.setCategory(WebloggerFactory.getWeblogger().getWeblogEntryManager().getWeblogCategoryByName(testWeblog, "General"));
