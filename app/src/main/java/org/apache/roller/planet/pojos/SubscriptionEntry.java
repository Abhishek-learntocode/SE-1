...
// Note: No import of Subscription — depends on SubscriptionEntryContainer interface instead
...
public class SubscriptionEntry implements Serializable, Comparable<SubscriptionEntry> {
    ...
    // associations
    private SubscriptionEntryContainer subscription = null;
    ...
    public SubscriptionEntryContainer getSubscription() {
        return subscription;
    }
    
    public void setSubscription(SubscriptionEntryContainer subscription) {
    ...
    /**
     * Read-only synonym for getSubscription()
     */
    public SubscriptionEntryContainer getWebsite() {
