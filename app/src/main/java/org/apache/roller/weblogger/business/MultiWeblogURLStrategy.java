 ...
 *
 * <p>This class implements {@link URLStrategy} directly, providing both the
 * admin/UI URL methods (previously in {@code AbstractURLStrategy}) and the
 * weblog-content URL methods. The abstract base class was removed because
 * this class never overrode any of its methods — the inheritance existed
 * purely for code reuse, constituting a Broken Hierarchy smell.</p>
 */
public class MultiWeblogURLStrategy implements URLStrategy {
    ...
    public String getLoginURL(boolean absolute) {
        ...
        StringBuilder url = new StringBuilder(URLBuilderUtils.URL_BUFFER_SIZE);
    ...
    public String getWeblogCollectionURL(Weblog weblog,
        ...
        StringBuilder pathinfo = new StringBuilder(URLBuilderUtils.URL_BUFFER_SIZE);
        Map<String, String> params = new HashMap<>();
