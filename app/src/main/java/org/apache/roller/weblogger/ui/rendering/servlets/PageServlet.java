    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("popup") != null) {
            try {
                ...
                page = WebloggerFactory.getWeblogger().getThemeManager().getTheme(weblog).getTemplateByName("_popupcomments");
            } catch (Exception e) {
            ...
            try {
                page = WebloggerFactory.getWeblogger().getThemeManager().getTheme(weblog).getTemplateByAction(
        ...
        if (page == null) {
            try {
                page = WebloggerFactory.getWeblogger().getThemeManager().getTheme(weblog).getDefaultTemplate();
            } catch (Exception e) {
                log.error(
