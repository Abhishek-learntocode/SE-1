...
public class ThemeEdit extends UIAction {
        ...
        try {
            if (!WeblogTheme.CUSTOM.equals(getActionWeblog().getEditorTheme())
                ...
                ThemeTemplate override = WebloggerFactory
                        ...
                        .getTemplateByLink(
                                getActionWeblog(),
                                WebloggerFactory.getWeblogger().getThemeManager().getTheme(getActionWeblog()).getStylesheet()
                                        .getLink());
                if (override != null) {
    ...
    public String execute() {
        ...
        if (WeblogTheme.CUSTOM.equals(getActionWeblog().getEditorTheme())) {
            ...
            try {
                setThemeId(WebloggerFactory.getWeblogger().getThemeManager().getTheme(getActionWeblog()).getId());
        ...
        if (WeblogTheme.CUSTOM.equals(getThemeType())) {
            ...
            if (!hasActionErrors()) {
                try {
                    ...
                    if (!originalTheme.equals(selectedThemeId) && WebloggerFactory.getWeblogger().getThemeManager().getTheme(getActionWeblog()).getStylesheet() != null) {
