...
public class Templates extends UIAction {
    ...
    public String execute() {
        ...
        try {
            ...
            if (WebloggerFactory.getWeblogger().getThemeManager().getTheme(getActionWeblog()).getStylesheet() != null) {
                pages.remove(WebloggerFactory.getWeblogger().getWeblogManager()
                    .getTemplateByLink(getActionWeblog(), WebloggerFactory.getWeblogger().getThemeManager().getTheme(getActionWeblog()).getStylesheet().getLink()));
            }
            setTemplates(pages);
            ...
            try {
                if (!template.isRequired()
                    ...
                    if (template.getName().equals(WeblogTemplate.DEFAULT_PAGE)) {
                        ...
                        ThemeTemplate stylesheet = WebloggerFactory.getWeblogger().getThemeManager().getTheme(getActionWeblog()).getStylesheet();

                        // Delete style sheet if the same name
                        if (stylesheet != null
                            && WebloggerFactory.getWeblogger().getThemeManager().getTheme(getActionWeblog()).getStylesheet() != null
                            && stylesheet.getLink().equals(
                            WebloggerFactory.getWeblogger().getThemeManager().getTheme(getActionWeblog()).getStylesheet().getLink())) {
