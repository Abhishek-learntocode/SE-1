...
public class PreviewServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // If request specified tags section index, then look for custom template
            ...
            try {
                page = WebloggerFactory.getWeblogger().getThemeManager().getTheme(weblog).getTemplateByAction(ComponentType.TAGSINDEX);
            } catch(Exception e) {
        ...
        // If this is a permalink then look for a permalink template
            ...
            try {
                page = WebloggerFactory.getWeblogger().getThemeManager().getTheme(weblog).getTemplateByAction(ComponentType.PERMALINK);
            } catch(Exception e) {
        ...
        if(page == null) {
            try {
                page = WebloggerFactory.getWeblogger().getThemeManager().getTheme(tmpWebsite).getDefaultTemplate();
