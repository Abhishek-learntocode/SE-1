...
public class WeblogEntry implements Serializable {
   ...
   //------------------------------------------------------ Simple properties
    ...
    public void addTag(String name) throws WebloggerException {
        WeblogEntryTagHandler.addTag(this, name);
    }
    ...
    public String getTagsAsString() {
        return WeblogEntryTagHandler.getTagsAsString(this);
    }

    public void setTagsAsString(String tags) throws WebloggerException {
        WeblogEntryTagHandler.setTagsAsString(this, tags);
    }
    ...
    public String getDisplayTitle() {
        return WeblogEntryContentHelper.getDisplayTitle(this);
    }
    ...
    public String getRss09xDescription() {
        return WeblogEntryContentHelper.getRss09xDescription(this);
    }
    ...
    public String getRss09xDescription(int maxLength) {
        return WeblogEntryContentHelper.getRss09xDescription(this, maxLength);
    }
    ...
    public String getTransformedText() {
        return WeblogEntryContentHelper.transformText(this);
    }
    ...
    public String getTransformedSummary() {
        return WeblogEntryContentHelper.transformSummary(this);
    }
    ...
    public String displayContent(String readMoreLink) {
        return WeblogEntryContentHelper.displayContent(this, readMoreLink);
    }
    ...
    public String getDisplayContent() { 
        return WeblogEntryContentHelper.getDisplayContent(this);
    }
