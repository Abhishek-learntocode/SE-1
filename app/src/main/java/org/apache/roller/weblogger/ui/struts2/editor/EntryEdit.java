...
public final class EntryEdit extends UIAction {
    ...
    public String publish() {
        ...
        try {
            hasPermission = WebloggerFactory.getWeblogger().getUserManager().checkPermission(
                    new WeblogPermission(getActionWeblog(), getAuthenticatedUser(), Collections.singletonList(WeblogPermission.POST)), getAuthenticatedUser());
        } catch (WebloggerException ex) {
