...
public class JPAWeblogManagerImpl implements WeblogManager {
    ...
    private final WeblogSetupService weblogSetupService;
    ...
    protected JPAWeblogManagerImpl(Weblogger roller, JPAPersistenceStrategy strat, WeblogSetupService weblogSetupService) {
        ...
        this.roller = roller;
        this.strategy = strat;
        this.weblogSetupService = weblogSetupService;
    }
    ...
    public void addWeblog(Weblog newWeblog) throws WebloggerException {
        ...
        this.strategy.flush();
        this.weblogSetupService.initializeWeblogContents(newWeblog);
    }
