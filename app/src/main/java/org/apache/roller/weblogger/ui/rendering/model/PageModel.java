...
public class PageModel implements Model {
    ...
    public void init(Map<String, Object> initData) throws WebloggerException {
        ...
        WeblogRequestContext weblogRequest = (WeblogRequestContext) initData.get("parsedRequest");
        ...
        this.deviceType = pageRequest.getDeviceType();
    }    
    ...
    public ThemeTemplateWrapper getWeblogPage() {
        if(pageRequest.getWeblogPageName() != null) {
            ...
            try {
                return ThemeTemplateWrapper.wrap(WebloggerFactory.getWeblogger().getThemeManager().getTheme(weblog).getDefaultTemplate());
