    ...
    public void doGet(HttpServletRequest request,
        ...
        try {
            ...
            if (c == null) {
                ...
                if (WebloggerFactory.getWeblogger().getUserManager().checkPermission(
                        new WeblogPermission(weblog, rses.getAuthenticatedUser(), Collections.singletonList(WeblogPermission.POST)), rses.getAuthenticatedUser())) {
